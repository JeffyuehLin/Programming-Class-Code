#include <stdio.h>
#include <string.h>
void usage(void){  //if the user input the wrong option, it will appear this messege
...
int mystrstr(char *line, char *pat, int *statecount){//distinguish the pattern and the line
...
int main(int argc, char **argv){
    char line[1001];
    int statecount = 0;
    if(argc!=3 && strcmp(argv[0],"a.out")!=0){   //distinguish the parameters are correct
        usage();
        return 0;
    }
